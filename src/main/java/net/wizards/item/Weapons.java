...
import net.spell_engine.api.config.Config;
...
public class Weapons {
    ...
    private static Weapon.Entry entry(String name, Weapon.CustomMaterial material, Weapon.Factory factory, Config.Weapon defaults) {
        return entry(null, name, material, factory, defaults);
    }

    private static Weapon.Entry entry(String requiredMod, String name, Weapon.CustomMaterial material, Weapon.Factory factory, Config.Weapon defaults) {
    ...
    private static Weapon.Entry wand(String name, Weapon.CustomMaterial material) {
        return entry(name, material, StaffItem::new, new Config.Weapon(wandAttackDamage, wandAttackSpeed));
    }
    ...
    public static final Weapon.Entry noviceWand = wand("wand_novice",
            ...
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FIRE.id, 3));
    public static final Weapon.Entry arcaneWand = wand("wand_arcane",
            ...
            .attribute(Config.AttributeModifier.bonus(SpellSchools.ARCANE.id, 4F));
    public static final Weapon.Entry fireWand = wand("wand_fire",
            Weapon.CustomMaterial.matching(ToolMaterials.IRON, () -> Ingredient.ofItems(Items.GOLD_INGOT)))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FIRE.id, 4F));
    public static final Weapon.Entry frostWand = wand("wand_frost",
            ...
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FROST.id, 4F));
    ...
    public static final Weapon.Entry netheriteArcaneWand = wand("wand_netherite_arcane",
            ...
            .attribute(Config.AttributeModifier.bonus(SpellSchools.ARCANE.id, 4.5F));
    public static final Weapon.Entry netheriteFireWand = wand("wand_netherite_fire",
            Weapon.CustomMaterial.matching(ToolMaterials.NETHERITE, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FIRE.id, 4.5F));
    public static final Weapon.Entry netheriteFrostWand = wand("wand_netherite_frost",
            Weapon.CustomMaterial.matching(ToolMaterials.NETHERITE, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FROST.id, 4.5F));
    ...
    private static Weapon.Entry staff(String requiredMod, String name, Weapon.CustomMaterial material) {
        return entry(requiredMod, name, material, StaffItem::new, new Config.Weapon(staffAttackDamage, staffAttackSpeed));
    }
    ...
    public static final Weapon.Entry wizardStaff = staff("staff_wizard",
            ...
            .attribute(Config.AttributeModifier.bonus(SpellSchools.ARCANE.id, 4))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FIRE.id, 4))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FROST.id, 4));
    public static final Weapon.Entry arcaneStaff = staff("staff_arcane",
            ...
            .attribute(Config.AttributeModifier.bonus(SpellSchools.ARCANE.id, 5));
    public static final Weapon.Entry fireStaff = staff("staff_fire",
            Weapon.CustomMaterial.matching(ToolMaterials.DIAMOND, () -> Ingredient.ofItems(Items.GOLD_INGOT)))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FIRE.id, 5));
    public static final Weapon.Entry frostStaff = staff("staff_frost",
            ...
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FROST.id, 5));

    public static final Weapon.Entry netheriteArcaneStaff = staff("staff_netherite_arcane",
            Weapon.CustomMaterial.matching(ToolMaterials.NETHERITE, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.ARCANE.id, 6));
    public static final Weapon.Entry netheriteFireStaff = staff("staff_netherite_fire",
            Weapon.CustomMaterial.matching(ToolMaterials.NETHERITE, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FIRE.id, 6));
    public static final Weapon.Entry netheriteFrostStaff = staff("staff_netherite_frost",
            Weapon.CustomMaterial.matching(ToolMaterials.NETHERITE, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)))
            .attribute(Config.AttributeModifier.bonus(SpellSchools.FROST.id, 6));

    // MARK: Register

    public static void register(Map<String, Config.Weapon> configs) {
        if (WizardsMod.tweaksConfig.value.ignore_items_required_mods || FabricLoader.getInstance().isModLoaded(BETTER_NETHER)) {
            ...
            staff("staff_ruby_fire",
                    ...
                    .attribute(Config.AttributeModifier.bonus(SpellSchools.FIRE.id, 7));
        }
        if (WizardsMod.tweaksConfig.value.ignore_items_required_mods || FabricLoader.getInstance().isModLoaded(BETTER_END)) {
            ...
            staff("staff_crystal_arcane",
                    Weapon.CustomMaterial.matching(ToolMaterials.NETHERITE, repair))
                    .attribute(Config.AttributeModifier.bonus(SpellSchools.ARCANE.id, 7));
            staff("staff_smaragdant_frost",
                    Weapon.CustomMaterial.matching(ToolMaterials.NETHERITE, repair))
                    .attribute(Config.AttributeModifier.bonus(SpellSchools.FROST.id, 7));
        }
