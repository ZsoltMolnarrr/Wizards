...
public class WizardsSounds {
    public static final class Entry {
        ...
        public Entry(String name) {
            this(Identifier.fromNamespaceAndPath(WizardsMod.ID, name));
        }
    ...
    public static final Entry ARCANE_BARRAGE_RELEASE = add(new Entry("arcane_barrage_release"));
    ...
    public static final Entry FROST_SPIKE_IMPACT = add(new Entry("frost_spike_impact").variants(3));
    ...
    public static final Entry FROST_LANCE_CASTING = add(new Entry("frost_lance_casting"));
    public static final Entry FROST_LANCE_IMPACT = add(new Entry("frost_lance_impact"));
    public static final Entry FROST_LANCE_RELEASE = add(new Entry("frost_lance_release"));
