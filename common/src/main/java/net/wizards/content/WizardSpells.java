...
public class WizardSpells {
    ...
    private static Entry arcane_bolt() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_bolt");
    ...
    private static Entry arcane_blast() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_blast");
    ...
    private static Entry arcane_missile() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_missile");
    ...
    private static Entry arcane_explosion() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_explosion");
    ...
    private static Entry arcane_beam() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_beam");
    ...
    private static Entry arcane_barrage() {
        ...
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_barrage");
        var spell = SpellBuilder.createSpellActive();
        spell.school = SpellSchools.ARCANE;
        spell.tier = 3;
        spell.group = CONJURATION;
    ...
    private static Entry arcane_blink() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_blink");
        var name = "Blink";
        ...
        spell.release = new Spell.Release();
        spell.release.animation = PlayerAnimation.of("spell_engine:one_handed_area_release");
        spell.release.sound = new Sound(Identifier.fromNamespaceAndPath("minecraft", "entity.enderman.teleport"));
    ...
    private static Entry arcane_evocation() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "arcane_evocation");
        var name = "Evocation";
        var description = "Channel to gain Evocation, stacking up to {effect_amplifier_cap} times, lasting {effect_duration} sec. Each stack increases spell critical strike chance and spell haste by "
                + TooltipTokens.effect(WizardsEffects.evocation.id, 0, Identifier.parse("spell_power:critical_chance"))
                + ", but also increases damage you take by "
                + TooltipTokens.effect(WizardsEffects.evocation.id, 0, Identifier.parse("spell_engine:damage_taken"))
                + ".";
        var spell = SpellBuilder.createSpellActive();
        spell.school = SpellSchools.ARCANE;
        spell.tier = 4;
    ...
    private static Entry fire_scorch() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_scorch");
        var name = "Scorch";
    ...
    private static Entry fireball() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fireball");
        var name = "Fireball";
    ...
    private static Entry fire_blast() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_blast");
        var name = "Pyroblast";
    ...
    private static Entry fire_breath() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_breath");
    ...
    private static Entry fire_slash() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_slash");
    ...
    private static Entry fire_meteor() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_meteor");
        var name = "Meteor";
    ...
    private static Entry firestorm() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_storm");
        var name = "Firestorm";
...
//        );
    ...
    private static Entry fire_wall() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_wall");
    ...
    private static Entry fire_hydra() {
        ...
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "fire_hydra");
        var spell = SpellBuilder.createSpellActive();
        spell.school = SpellSchools.FIRE;
        spell.tier = 4;
        spell.group = DESTRUCTION;
    ...
    private static Entry frost_shard() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frost_shard");
    ...
    private static Entry frostbolt() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frostbolt");
        var name = "Frostbolt";
    ...
    private static Entry frost_nova() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frost_nova");
        var name = "Frost Nova";
    ...
    private static Entry frost_spikes() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frost_spikes");
    ...
    private static Entry frost_shield() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frost_shield");
    ...
    private static Entry ice_lance() {
        ...
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frost_lance");
        var spell = SpellBuilder.createSpellActive();
        spell.school = SpellSchools.FROST;
        spell.tier = 3;
        spell.group = RIME;
    ...
    private static Entry frost_blizzard() {
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frost_blizzard");
        var name = "Blizzard";
    ...
    private static Entry frost_elemental() {
        ...
        var id = Identifier.fromNamespaceAndPath(WizardsMod.ID, "frost_elemental");
        var spell = SpellBuilder.createSpellActive();
        spell.school = SpellSchools.FROST;
        spell.tier = 4;
        spell.group = RIME;
